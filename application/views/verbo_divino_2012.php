	...
	<div class="container extra-margin" id="verbodivino">
		<div class="row">
			<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12"><h2><?php echo $this->lang->line('v2012_title'); ?></h2><br /></div>

			<div class="col-sm-5 col-xs-12 col-md-5 col-lg-5">
				<p><?php echo $this->lang->line('v2012_description'); ?><br /> <?php echo $this->lang->line('v2012_location'); ?></p>
				<p><?php echo $this->lang->line('v2012_website'); ?></p>
				<br />
				<p>
				<?php echo $this->lang->line('v2012_detail'); ?>
	...
	<div class="row extra-margin text-center">
		<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
			<a href="<?php echo base_url('contaflex'); ?>" class="pagination"><?php echo $this->lang->line('pagination_back'); ?></a>
			<a href="<?php echo base_url('index'); ?>" class="pagination"><?php echo $this->lang->line('pagination_index'); ?></a>
			<a href="<?php echo base_url('verbo_divino_2015'); ?>" class="pagination"><?php echo $this->lang->line('pagination_next'); ?></a>
		</div>
	</div>
